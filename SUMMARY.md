...
* [📖 Plugin usage](plugin-usage/README.md)
  ...
  * [📷 Resourcepack hosting](plugin-usage/resourcepack-hosting/README.md)
    ...
    * [1⃣ 1⃣ 1⃣ OneDrive](plugin-usage/resourcepack-hosting/onedrive.md)
  * [🎨 Adding content](plugin-usage/advanced/README.md)
    * [ℹ Basic concepts](plugin-usage/advanced/basic-concepts/README.md)
      * [Namespace](plugin-usage/advanced/basic-concepts/namespace/README.md)
        * [Creating your namespace](plugin-usage/advanced/basic-concepts/namespace/creating-your-namespace.md)
      * [items\_packs and resource\_pack](plugin-usage/advanced/basic-concepts/items\_packs-and-resource\_pack.md)
    * [⛏ Example items](plugin-usage/advanced/creating-a-custom-item/README.md)
      * [Sword](plugin-usage/advanced/creating-a-custom-item/sword.md)
      * [Armor](plugin-usage/advanced/creating-a-custom-item/armor.md)
      * [Custom Arrows](plugin-usage/advanced/creating-a-custom-item/custom-arrows.md)
      * [Magic wand](plugin-usage/advanced/creating-a-custom-item/magic-wand.md)
      * [Blocks](plugin-usage/advanced/creating-a-custom-item/blocks/README.md)
        * [Block](plugin-usage/advanced/creating-a-custom-item/blocks/block.md)
        * [Drop exp from blocks](plugin-usage/advanced/creating-a-custom-item/blocks/drop-exp-from-blocks.md)
      * [Fuel](plugin-usage/advanced/creating-a-custom-item/fuel.md)
      * [Bundle](plugin-usage/advanced/creating-a-custom-item/bundle.md)
    * [📜 Item properties](plugin-usage/advanced/item-properties/README.md)
      * [Basic](plugin-usage/advanced/item-properties/basic/README.md)
        * [Item Permission](plugin-usage/advanced/item-properties/basic/item-permission.md)
        * [Templates and variants](plugin-usage/advanced/item-properties/basic/templates-and-variants.md)
      * [🖼 Resource](plugin-usage/advanced/item-properties/resource/README.md)
        * [Creating 3D models](plugin-usage/advanced/item-properties/resource/creating-3d-models.md)
      * [Specific properties](plugin-usage/advanced/item-properties/specific-properties/README.md)
        * [Blocks](plugin-usage/advanced/item-properties/specific-properties/blocks.md)
      * [⚡ Events](plugin-usage/advanced/item-properties/events/README.md)
        * [Actions](plugin-usage/advanced/item-properties/events/actions.md)
      * [Behaviours](plugin-usage/advanced/item-properties/behaviours.md)
    * [🍳 Recipes](plugin-usage/advanced/recipes/README.md)
      * [Crafting](plugin-usage/advanced/recipes/crafting.md)
      * [Cooking](plugin-usage/advanced/recipes/cooking.md)
      * [Anvil repair](plugin-usage/advanced/recipes/anvil-repair.md)
    * [🇬🇧 🇬🇧 🇬🇧 Translation](plugin-usage/advanced/translation.md)
    * [🎁 Loots](plugin-usage/advanced/loots.md)
    * [💎 Worlds populators](plugin-usage/advanced/worlds-populators.md)
    * [🌳 Trees populators](plugin-usage/advanced/trees-populators/README.md)
      * [Leaves and wood](plugin-usage/advanced/trees-populators/laveas-and-wood.md)
      * [Populator](plugin-usage/advanced/trees-populators/populator.md)
      * [Saplings](plugin-usage/advanced/trees-populators/saplings.md)
    * [🍄 Surface populators](plugin-usage/advanced/surface-populators.md)
    * [🖼 Font Images](plugin-usage/advanced/font-images/README.md)
      * [Common errors](plugin-usage/advanced/font-images/common-errors.md)
      * [Placeholders](plugin-usage/advanced/font-images/placeholders.md)
      * [Manually creating font images](plugin-usage/advanced/font-images/manually-creating-font-images.md)
      * [😁 Emojis](plugin-usage/advanced/font-images/emojis.md)
      * [😄 Using font\_images/emojis everywhere](plugin-usage/advanced/font-images/using-font\_images-emojis-everywhere.md)
    * [🔊 Sounds](plugin-usage/advanced/sounds/README.md)
      * [Convert sound to .ogg](plugin-usage/advanced/sounds/convert-sound-to-.ogg.md)
      * [🎹 Music discs](plugin-usage/advanced/sounds/music-discs.md)
    * [🥷 Armors](plugin-usage/advanced/armors/README.md)
      * [Texture](plugin-usage/advanced/armors/texture.md)
    * [🔋 HUDs](plugin-usage/advanced/huds/README.md)
      * [Creating HUDs](plugin-usage/advanced/huds/creating-huds/README.md)
        * [Frames HUD](plugin-usage/advanced/huds/creating-huds/frames-hud.md)
        * [Status HUD](plugin-usage/advanced/huds/creating-huds/status-hud.md)
        * [Custom HUD (advanced)](plugin-usage/advanced/huds/creating-huds/custom-hud-advanced.md)
      * [Trigger value change](plugin-usage/advanced/huds/trigger-value-change.md)
    * [GUIs](plugin-usage/advanced/guis.md)
    * [🪑 Furniture](plugin-usage/advanced/furniture/README.md)
      * [Creating a furniture](plugin-usage/advanced/furniture/creating-a-furniture.md)
      * [Creating a chair](plugin-usage/advanced/furniture/creating-a-chair.md)
      * [Furniture collisions](plugin-usage/advanced/furniture/furniture-collisions.md)
      * [Furniture entity](plugin-usage/advanced/furniture/furniture-entity.md)
      * [Furniture size](plugin-usage/advanced/furniture/furniture-size.md)
      * [Furniture execute actions](plugin-usage/advanced/furniture/furniture-execute-actions.md)
    * [✍ Fonts](plugin-usage/advanced/fonts/README.md)
      * [Thin font (force unicode)](plugin-usage/advanced/fonts/thin-font-force-unicode.md)
      * [TTF font](plugin-usage/advanced/fonts/method-1.md)
      * [PNG font (easier)](plugin-usage/advanced/fonts/method-2.md)
    * [🐖 Entities](plugin-usage/advanced/mobs/README.md)
      * [Advanced method](plugin-usage/advanced/mobs/advanced-method/README.md)
        * [Creation](plugin-usage/advanced/mobs/advanced-method/creation.md)
        * [Common errors](plugin-usage/advanced/mobs/advanced-method/common-errors.md)
        * [Animations](plugin-usage/advanced/mobs/advanced-method/animations.md)
        * [Mount](plugin-usage/advanced/mobs/advanced-method/mount.md)
        * [Head](plugin-usage/advanced/mobs/advanced-method/head.md)
        * [Hitbox](plugin-usage/advanced/mobs/advanced-method/hitbox.md)
        * [Particles](plugin-usage/advanced/mobs/advanced-method/particles.md)
        * [Sounds](plugin-usage/advanced/mobs/advanced-method/sounds.md)
        * [Hands equipment](plugin-usage/advanced/mobs/advanced-method/hands-equipment.md)
      ...
      * [Old method](plugin-usage/advanced/mobs/old-method/README.md)
        * [Creating the mob](plugin-usage/advanced/mobs/old-method/creating-the-mob/README.md)
          * [Configuration](plugin-usage/advanced/mobs/old-method/creating-the-mob/configuration.md)
          * [3D model](plugin-usage/advanced/mobs/old-method/creating-the-mob/3d-model.md)
        * [Spawning custom mobs naturally](plugin-usage/advanced/mobs/old-method/spawning-custom-mobs-naturally/README.md)
          * [Using MythicMobs](plugin-usage/advanced/mobs/old-method/spawning-custom-mobs-naturally/using-mythicmobs.md)
          * [ItemsAdder internal](plugin-usage/advanced/mobs/old-method/spawning-custom-mobs-naturally/itemsadder-internal.md)
    * [ℹ Items tooltips](plugin-usage/advanced/items-tooltips.md)
    * [Animated titles](plugin-usage/advanced/animated-titles.md)
    * [🔖 Ranks textures (tags)](plugin-usage/advanced/ranks-textures-tags.md)
    * [🇬🇧 🇬🇧 🇬🇧 Minecraft translation files](plugin-usage/advanced/minecraft-translation-files.md)
    * [🎨 Colored models](plugin-usage/advanced/colored-models.md)
    * [Custom NBT](plugin-usage/advanced/custom-nbt.md)
    * [⚙ Optifine only features](plugin-usage/advanced/optifine-only-features/README.md)
      * [Loading screen](plugin-usage/advanced/optifine-only-features/loading-screen.md)
      * [Armor textures (old method)](plugin-usage/advanced/optifine-only-features/armor-textures.md)
